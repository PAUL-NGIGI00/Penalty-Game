...
shootout. Mirrors the structure of the original PK_GUI.py from the
PyQt6 version, but built for pygame's draw-loop model instead of Qt's
widget/event model.
...
# Main Game class (state machine + rendering)
